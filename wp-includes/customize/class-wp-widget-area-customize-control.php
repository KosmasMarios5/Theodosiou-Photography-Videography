...
class WP_Widget_Area_Customize_Control extends WP_Customize_Control {
 ...
 esc_attr_e( 'Reorder widgets' ); ?>" aria-describedby="<?php
 echo esc_attr( $id ); ?>">
 ...
 _e( 'When in reorder mode, additional controls to reorder widgets will be available in the widgets list above.' ); ?></p>
		<?php
