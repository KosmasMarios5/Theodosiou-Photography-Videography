...
<channel rdf:about="<?php
 ...
 bloginfo_rss( 'description' ); ?></description>
	<dc:date><?php
 echo get_feed_build_date( 'Y-m-d\TH:i:s\Z' ); ?>	</dc:date>
	<sy:updatePeriod>
	<?php
...
<item rdf:about="<?php
 ...
 the_author(); ?>]]></dc:creator>
	<dc:date><?php
 echo mysql2date( 'Y-m-d\TH:i:s\Z', $post->post_date_gmt, false ); ?></dc:date>
	<?php
 ...
 the_content_feed( 'rdf' ); ?>]]></content:encoded>
	<?php
 endif; ?>
