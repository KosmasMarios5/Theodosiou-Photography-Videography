...
?>
        ...
        <div <?php
 echo $this->get_render_attribute_string('eael_flipbox_main_wrap'); ?>>

            <<?php
 echo $flipbox_if_html_tag, ' ', $this->get_render_attribute_string('flipbox-container'); ?>>
                        ...
                        <div class="eael-elements-flip-box-vertical-align">
                            <div class="eael-elements-flip-box-padding">
                                <div class="eael-elements-flip-box-icon-image">
                                    <?php
 if ('icon' === $settings['eael_flipbox_img_or_icon']) : ?>
                                        <?php
 if ($front_icon_is_new || $front_icon_migrated) { ?>
                                            <?php
 if (isset($settings['eael_flipbox_icon_new']['value']['url'])) : ?>
                                                <img class="eael-flipbox-svg-icon" src="<?php
 echo esc_attr($settings['eael_flipbox_icon_new']['value']['url']); ?>" alt="<?php
 echo esc_attr(get_post_meta($settings['eael_flipbox_icon_new']['value']['id'], '_wp_attachment_image_alt', true)); ?>" />
                                            <?php
 else : ?>
                                                <i class="<?php
 echo esc_attr($settings['eael_flipbox_icon_new']['value']); ?>"></i>
                                            <?php
 endif; ?>
                                        <?php
 } else { ?>
                                            <i class="<?php
 echo esc_attr($settings['eael_flipbox_icon']); ?>"></i>
                                        <?php
 } ?>
                                    <?php
 elseif ('img' === $settings['eael_flipbox_img_or_icon']) : ?>
                                        <img class="eael-flipbox-image-as-icon" src="<?php
 echo esc_url($flipbox_image_url); ?>" alt="<?php
 echo esc_attr(get_post_meta($flipbox_image['id'], '_wp_attachment_image_alt', true)); ?>">
                                    <?php
 endif; ?>
                                </div>
                                <<?php
 echo $settings['eael_flipbox_front_title_tag']; ?> class="eael-elements-flip-box-heading"><?php
 echo esc_html__($settings['eael_flipbox_front_title'], 'essential-addons-for-elementor-lite'); ?></<?php
 echo $settings['eael_flipbox_front_title_tag']; ?>>
                                <div class="eael-elements-flip-box-content">
                                    <p><?php
 echo __($settings['eael_flipbox_front_text'], 'essential-addons-for-elementor-lite'); ?></p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="eael-elements-flip-box-rear-container">
                    <div class="eael-elements-slider-display-table">
                        <div class="eael-elements-flip-box-vertical-align">
                            <div class="eael-elements-flip-box-padding">
                                <?php
 if ('none' != $settings['eael_flipbox_img_or_icon_back']) : ?>
                                    <div class="eael-elements-flip-box-icon-image">
                                        <?php
 if ('img' == $settings['eael_flipbox_img_or_icon_back']) : ?>
                                            <img class="eael-flipbox-image-as-icon" <?php
 echo $this->get_render_attribute_string('flipbox-back-icon-image-container'); ?>>
                                        <?php
 elseif ('icon' == $settings['eael_flipbox_img_or_icon_back']) : ?>
                                            <?php
 if ($back_icon_is_new || $back_icon_migrated) { ?>
                                                <?php
 if (isset($settings['eael_flipbox_icon_back_new']['value']['url'])) : ?>
                                                    <img class="eael-flipbox-svg-icon" src="<?php
 echo esc_attr($settings['eael_flipbox_icon_back_new']['value']['url']); ?>" alt="<?php
 echo esc_attr(get_post_meta($settings['eael_flipbox_icon_back_new']['value']['id'], '_wp_attachment_image_alt', true)); ?>" />
                                                <?php
 else : ?>
                                                    <i class="<?php
 echo esc_attr($settings['eael_flipbox_icon_back_new']['value']); ?>"></i>
                                                <?php
 endif; ?>
                                            <?php
 } else { ?>
                                                <i class="<?php
 echo esc_attr($settings['eael_flipbox_icon_back']); ?>"></i>
                                            <?php
 } ?>
                                        <?php
 endif; ?>
                                ...
                                <<?php
 echo $flipbox_if_html_title_tag, ' ', $this->get_render_attribute_string('flipbox-title-container'); ?>><?php
 echo esc_html__($settings['eael_flipbox_back_title'], 'essential-addons-for-elementor-lite'); ?></<?php
 echo $flipbox_if_html_title_tag; ?>>
                                <div class="eael-elements-flip-box-content">
                                    <p><?php
 echo __($settings['eael_flipbox_back_text'], 'essential-addons-for-elementor-lite'); ?></p>
                                </div>

                                <?php
 if ($settings['flipbox_link_type'] == 'button' && !empty($settings['flipbox_button_text'])) : ?>
                                    <a <?php
 echo $this->get_render_attribute_string('flipbox-button-container'); ?>>
                                        <?php
 if ('before' == $settings['button_icon_position']) : ?>
                                            <?php
 if ($button_icon_is_new || $button_icon_migrated) { ?>
                                                <i class="<?php
 echo $settings['button_icon_new']['value']; ?>"></i>
                                            <?php
 } else { ?>
                                                <i class="<?php
 echo $settings['button_icon']; ?>"></i>
                                            <?php
 } ?>
                                        <?php
 endif; ?>
