...
?>
 ...
 if ($settings['eael_fg_all_label_text']) { ?>
                        <li class="control all-control active" data-filter="*"><?php
 echo $all_text; ?></li>
                    <?php
 } ?>
 ...
 if ($key == 0 && empty($settings['eael_fg_all_label_text'])) {
                                                echo 'active';
                                            } ?>" data-filter=".eael-cf-<?php
 echo esc_attr($sorter_filter); ?>"><?php
 echo esc_html__($control['eael_fg_control']); ?></li>
                    <?php
 endforeach; ?>
                </ul>
            </div>
            ...
            <div class="fg-layout-3-filters-wrap">
                <div class="fg-filter-wrap">
                    ...
                    <ul class="fg-layout-3-filter-controls">
                        <?php
 if ($settings['eael_fg_all_label_text']) { ?>
                            <li class="control active" data-filter="*"><?php
 echo $settings['eael_fg_all_label_text']; ?></li>
                        <?php
 } ?>
 ...
 endforeach; ?>
                ...
                <form class="fg-layout-3-search-box" id="fg-layout-3-search-box" autocomplete="off">
                    <input type="text" id="fg-search-box-input" name="fg-frontend-search" placeholder="<?php
 echo $settings['fg_sf_placeholder']; ?>" />
                </form>
    ...
    protected function render_loadmore_button()
    {
        ...
        if ($settings['pagination'] == 'yes') { ?>
            <div class="eael-filterable-gallery-loadmore">
                <a href="#" <?php
 echo $this->get_render_attribute_string('load-more-button'); ?>>
 ...
 if (isset($settings['load_more_icon_new']['value']['url'])) : ?>
                                <img class="eael-filterable-gallery-load-more-icon fg-load-more-icon-left" src="<?php
 echo esc_url($settings['load_more_icon_new']['value']['url']); ?>" alt="<?php
 echo esc_attr(get_post_meta($settings['load_more_icon_new']['value']['id'], '_wp_attachment_image_alt', true)); ?>" />
                            <?php
 else : ?>
                                <span class="eael-filterable-gallery-load-more-icon fg-load-more-icon-left <?php
 echo esc_attr($settings['load_more_icon_new']['value']); ?>" aria-hidden="true"></span>
                            <?php
 endif; ?>
                        <?php
 } else { ?>
                            <span class="eael-filterable-gallery-load-more-icon fg-load-more-icon-left <?php
 echo esc_attr($settings['load_more_icon']); ?>" aria-hidden="true"></span>
                        <?php
 } ?>
                    <?php
 } ?>
 ...
 if ($icon_is_new || $icon_migrated) { ?>
                            <?php
 if (isset($settings['load_more_icon_new']['value']['url'])) : ?>
                                <img class="eael-filterable-gallery-load-more-icon fg-load-more-icon-right" src="<?php
 echo esc_url($settings['load_more_icon_new']['value']['url']); ?>" alt="<?php
 echo esc_attr(get_post_meta($settings['load_more_icon_new']['value']['id'], '_wp_attachment_image_alt', true)); ?>" />
                            <?php
 else : ?>
                                <span class="eael-filterable-gallery-load-more-icon fg-load-more-icon-right <?php
 echo esc_attr($settings['load_more_icon_new']['value']); ?>" aria-hidden="true"></span>
                            <?php
 endif; ?>
                        <?php
 ...
 echo esc_attr($settings['load_more_icon']); ?>" aria-hidden="true"></span>
    ...
    protected function render()
    {
        ...
        ?>
        <div <?php
 echo $this->get_render_attribute_string('gallery'); ?>>
            ...
            <div <?php
 echo $this->get_render_attribute_string('gallery-items-wrap'); ?>>
                <?php
