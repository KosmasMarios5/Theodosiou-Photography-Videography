...
class Adv_Tabs extends Widget_Base
{
    ...
    protected function render()
    {
        ...
        <div <?php
 echo $this->get_render_attribute_string('eael_tab_wrapper'); ?>>
            <div class="eael-tabs-nav">
                <ul <?php
 echo $this->get_render_attribute_string('eael_tab_icon_position'); ?>>
                    <?php
 foreach ($settings['eael_adv_tabs_tab'] as $tab) : ?>
                        <li class="<?php
 echo esc_attr($tab['eael_adv_tabs_tab_show_as_default']); ?>"><?php
 if ($settings['eael_adv_tabs_icon_show'] === 'yes') :
 ...
 if ($tab_icon_is_new || $tab_icon_migrated) {
                                ...
                                <?php
 elseif ($tab['eael_adv_tabs_icon_type'] === 'image') : ?>
                                    <img src="<?php
 echo esc_attr($tab['eael_adv_tabs_tab_title_image']['url']); ?>" alt="<?php
 echo esc_attr(get_post_meta($tab['eael_adv_tabs_tab_title_image']['id'], '_wp_attachment_image_alt', true)); ?>">
                                <?php
 endif; ?>
                            <?php
 endif; ?> <span class="eael-tab-title"><?php
 echo $tab['eael_adv_tabs_tab_title']; ?></span></li>
                    <?php
 endforeach; ?>
                </ul>
            </div>
            <div class="eael-tabs-content">
                <?php
 foreach ($settings['eael_adv_tabs_tab'] as $tab) : $eael_find_default_tab[] = $tab['eael_adv_tabs_tab_show_as_default']; ?>
                    <div class="clearfix <?php
 echo esc_attr($tab['eael_adv_tabs_tab_show_as_default']); ?>">
                        <?php
 if ('content' == $tab['eael_adv_tabs_text_type']) : ?>
                            <?php
 echo do_shortcode($tab['eael_adv_tabs_tab_content']); ?>
                        <?php
