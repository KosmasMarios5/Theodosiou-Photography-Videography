...
<div id="extensions" class="eael-settings-tab eael-extensions-list">
 ...
 echo isset( $item['is_pro'] ) && !$this->pro_enabled ? '<sup class="pro-label">'.__('Pro', 'essential-addons-for-elementor-lite').'</sup>' : ''; ?>
                                <?php
 if ($item['key'] === 'eael-post-duplicator') {
 ...
 echo ($item['demo_link']);?>" target="_blank">
 ...
 _e('Demo', 'essential-addons-elementor'); ?></span>
                            </a>
                            <a class="eael-element-info-link" href="<?php
 echo ($item['doc_link']);?>" target="_blank">
                                ...
                                <span class="eael-info-tooltip"><?php
 _e('Documentation', 'essential-addons-elementor'); ?></span>
                            </a>
                        </div>
 ...
 _e('Save settings', 'essential-addons-for-elementor-lite'); ?></button>
            </div>
        </div>
    </div>
</div>