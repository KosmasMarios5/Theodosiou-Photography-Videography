...
<script type="text/template" id="tmpl-elementor-panel-history-page">
	<div id="elementor-panel-elements-navigation" class="elementor-panel-navigation">
		<div class="elementor-component-tab elementor-panel-navigation-tab" data-tab="actions"><?php
 echo __( 'Actions', 'elementor' ); ?></div>
		<div class="elementor-component-tab elementor-panel-navigation-tab" data-tab="revisions"><?php
 echo __( 'Revisions', 'elementor' ); ?></div>
	</div>
...
<script type="text/template" id="tmpl-elementor-panel-history-tab">
	...
	<div class="elementor-history-revisions-message"><?php
 echo __( 'Switch to Revisions tab for older versions', 'elementor' ); ?></div>
</script>
...
<script type="text/template" id="tmpl-elementor-panel-history-no-items">
 ...
 echo __( 'No History Yet', 'elementor' ); ?></div>
	<div class="elementor-nerd-box-message"><?php
 echo __( 'Once you start working, you\'ll be able to redo / undo any action you make in the editor.', 'elementor' ); ?></div>
</script>
