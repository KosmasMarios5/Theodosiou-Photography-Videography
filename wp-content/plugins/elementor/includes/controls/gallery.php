			...
			<div class="elementor-control-input-wrapper">
				...
				<div class="elementor-control-media__content elementor-control-tag-area">
					...
					<div class="elementor-control-gallery-content">
						...
						<button class="elementor-button elementor-control-gallery-add" aria-label="<?php
 echo __( 'Add Images', 'elementor' ); ?>"><i class="eicon-plus-circle" aria-hidden="true"></i></button>
					</div>
				</div>
			</div>
		</div>
