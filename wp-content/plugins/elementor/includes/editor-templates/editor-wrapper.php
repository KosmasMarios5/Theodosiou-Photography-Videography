...
<head>
	...
	<title><?php
 echo __( 'Elementor', 'elementor' ) . ' | ' . get_the_title(); ?></title>
	<?php
 wp_head(); ?>
	<script>
		var ajaxurl = '<?php
...
<div id="elementor-editor-wrapper">
 ...
 if ( $notice ) { ?>
				<div id="elementor-notice-bar">
					...
					<div id="elementor-notice-bar__message"><?php
 echo sprintf( $notice['message'], $notice['action_url'] ); ?></div>
					<div id="elementor-notice-bar__action"><a href="<?php
 echo $notice['action_url']; ?>" target="_blank"><?php
 echo $notice['action_title']; ?></a></div>
