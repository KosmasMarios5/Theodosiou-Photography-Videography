...
class Eael_Licensing {
 ...
 if ( $status == false || $status !== 'valid' ) : ?>
      				...
      				<div class="eael-license-instruction">
	                    <p><?php
 _e( 'Enter your license key here, to activate <strong>Essential Addons for Elementor</strong>, and get automatic updates and premium support.', $this->text_domain ); ?></p>
	                    <p><?php
 printf( __( 'Visit the <a href="%s" target="_blank">Validation Guide</a> for help.', $this->text_domain ), 'https://essential-addons.com/elementor/docs/getting-started/validating-license/' ); ?></p>

	                    <ol>
	                        <li><?php
 printf( __( 'Log in to <a href="%s" target="_blank">your account</a> to get your license key.', $this->text_domain ), 'https://wpdeveloper.net/account/' ); ?></li>
	                        <li><?php
 printf( __( 'If you don\'t yet have a license key, get <a href="%s" target="_blank">Essential Addons for Elementor now</a>.', $this->text_domain ), 'https://wpdeveloper.net/in/upgrade-essential-addons-elementor' ); ?></li>
	                        <li><?php
 _e( __( 'Copy the license key from your account and paste it below.', $this->text_domain ) ); ?></li>
	                        <li><?php
 _e( __( 'Click on <strong>"Activate License"</strong> button.', $this->text_domain ) ); ?></li>
	                    </ol>
                	</div>
      				<?php
 endif; ?>
 ...
 if( $status !== false && $status == 'valid' ) { ?>
      				<div class="validated-feature-list">
      					<div class="validated-feature-list-item">
							  ...
							  <img src="<?php
 echo EAEL_PRO_PLUGIN_URL . 'assets/admin/images/icon-auto-update.svg'; ?>" alt="essential-addons-auto-update">
  							</div>
 ...
 echo EAEL_PRO_PLUGIN_URL . 'assets/admin/images/icon-auto-update.svg'; ?>" alt="essential-addons-auto-update">
  							...
  							<div class="validated-feature-list-content">
							  <h4><?php
 _e('Premium Support', $this->text_domain); ?></h4>
  								<p><?php
 _e('Supported by professional and courteous staff.', $this->text_domain); ?></p>
  							</div>
      					</div><!--./feature-list-item-->
      				</div><!--./feature-list-->
      				<?php
 ...
 if( $status !== false && $status == 'valid' ) { ?>
								<img src="<?php
 echo EAEL_PRO_PLUGIN_URL . 'assets/admin/images/icon-license-valid.svg'; ?>" alt="essential-addons-elementor-licnese">
							<?php
 } ?>
						...
						<div class="eael-license-input">
							<input <?php
 echo ( $status !== false && $status == 'valid' ) ? 'disabled' : ''; ?> id="<?php
 echo $this->product_slug; ?>-license-key" name="<?php
 echo $this->product_slug; ?>-license-key" type="text" class="regular-text" value="<?php
 echo esc_attr( self::get_hidden_license_key() ); ?>"" placeholder="Place Your License Key and Activate" />
						</div>
 ...
 echo $this->product_slug; ?>_license_deactivate" />
								<?php
 submit_button( __( 'Deactivate License', $this->text_domain ), 'eael-license-deactivation-btn', 'submit', false, array( 'class' => 'button button-primary' ) ); ?>
							<?php
 } else { ?>
								<input type="hidden" name="<?php
 echo $this->product_slug; ?>_license_activate" />
								<?php
 submit_button( __( 'Activate License', $this->text_domain ), 'eael-license-activation-btn', 'submit', false, array( 'class' => 'button button-primary' ) ); ?>
							<?php
 } ?>
						</div>
					</div>
